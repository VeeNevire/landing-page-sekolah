...
<section class="section" style="background:var(--card)">
  <div class="container split">
    <div class="reveal"><span class="kicker">Visi</span>
      <h2 class="section-title">Menjadi sekolah unggul yang melahirkan pembelajar berkarakter dan siap berkarya.</h2>
    </div>
...
<section class="section">
  <div class="container"><span class="kicker">Nilai utama</span>
    ...
    <div class="values" style="margin-top:30px">
      <div class="card value reveal">
        <h3>Integritas</h3>
        <p style="color:var(--muted)">Jujur, konsisten, dan dapat dipercaya.</p>
      </div>
      <div class="card value reveal">
        <h3>Keunggulan</h3>
        <p style="color:var(--muted)">Selalu belajar dan meningkatkan kualitas.</p>
      </div>
      <div class="card value reveal">
        <h3>Kolaborasi</h3>
        <p style="color:var(--muted)">Tumbuh bersama melalui kerja tim.</p>
      </div>
      <div class="card value reveal">
        <h3>Kepedulian</h3>
        <p style="color:var(--muted)">Menghargai manusia dan lingkungan.</p>
      </div>
    </div>
  </div>
</section>
<section class="section" style="background:var(--card)">
  <div class="container split">
    <div><span class="kicker">Perjalanan kami</span>
      <h2 class="section-title">Bertumbuh bersama perubahan zaman.</h2>
      <p class="section-desc">Template linimasa ini dapat disesuaikan dengan sejarah resmi sekolah.</p>
    </div>
    <div class="timeline">
      <div class="timeline-item reveal">
        <div class="timeline-date">2008</div>
        <div><strong>Sekolah didirikan</strong><span>Memulai layanan pendidikan menengah berbasis karakter.</span></div>
      </div>
      <div class="timeline-item reveal">
        <div class="timeline-date">2014</div>
        <div><strong>Pengembangan SMK</strong><span>Membuka program vokasi sesuai kebutuhan industri.</span></div>
      </div>
      <div class="timeline-item reveal">
        <div class="timeline-date">2021</div>
        <div><strong>Transformasi digital</strong><span>Menerapkan LMS, laboratorium digital, dan pembelajaran hibrida.</span></div>
      </div>
      <div class="timeline-item reveal">
        <div class="timeline-date">2026</div>
        <div><strong>Ekosistem pendidikan terpadu</strong><span>Penguatan kemitraan, sertifikasi, dan pusat karier siswa.</span></div>
      </div>
    </div>
  </div>
</section>
<section class="section">
  <div class="container"><span class="kicker">Fasilitas</span>
