...
<section class="hero">
  <div class="container hero-grid">
    <div class="reveal">
      <span class="hero-badge"><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle;margin-right:6px">
          <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
        </svg> Terakreditasi A &middot; Sekolah Berbasis Digital</span>
      ...
      <div class="hero-actions"><a class="btn btn-primary" href="{{ route('ppdb') }}">Mulai Pendaftaran <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle;margin-left:4px">
            <path d="M5 12h14" />
            <path d="m12 5 7 7-7 7" />
          </svg></a><a class="btn btn-outline" href="{{ route('profil') }}">Jelajahi Sekolah</a></div>
    ...
    <div class="visual reveal">
      ...
      <div class="visual-card float-card float-1">
        <div class="mini-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<section class="section">
  <div class="container">
    ...
    <div class="grid grid-3" style="margin-top:34px">
      <article class="card card-hover program-card reveal"><span class="tag">SMA</span>
        <div class="icon-box"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <article class="card card-hover program-card reveal"><span class="tag">SMK</span>
        <div class="icon-box"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<section class="section accent-section">
  <div class="container split">
    <div class="reveal"><span class="kicker" style="color:#ffdc8c">Pengalaman belajar</span>
      <h2 class="section-title">Belajar tidak berhenti di ruang kelas.</h2>
      <p class="section-desc">Siswa mengembangkan portofolio melalui klub, kompetisi, proyek sosial, kunjungan industri, praktik kerja, dan kegiatan kepemimpinan.</p><a class="btn btn-accent" style="margin-top:26px" href="{{ route('akademik') }}">Lihat Semua Program</a>
    </div>
    <div class="grid grid-2 reveal">
      <div class="card" style="color:var(--ink)"><strong style="font-size:1.4rem">15+</strong>
        <p style="color:var(--muted)">Ekstrakurikuler akademik, olahraga, seni, dan teknologi.</p>
      </div>
      <div class="card" style="color:var(--ink)"><strong style="font-size:1.4rem">2×</strong>
        <p style="color:var(--muted)">Career day dan pameran karya siswa setiap tahun.</p>
      </div>
      <div class="card" style="color:var(--ink)"><strong style="font-size:1.4rem">100%</strong>
        <p style="color:var(--muted)">Siswa SMK mengikuti praktik kerja lapangan.</p>
      </div>
      <div class="card" style="color:var(--ink)"><strong style="font-size:1.4rem">1:15</strong>
    ...
    <div class="grid grid-3" style="margin-top:34px">
      <article class="card news-card reveal">
        ...
        <div class="news-body">
          ...
          <p>Proyek sistem monitoring energi sekolah berhasil meraih penghargaan kategori solusi berkelanjutan.</p><a class="text-link" href="#">Baca berita <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle;margin-left:3px">
              <path d="M5 12h14" />
              <path d="m12 5 7 7-7 7" />
            </svg></a>
        </div>
      ...
      <article class="card news-card reveal">
        <div class="news-thumb" style="background:linear-gradient(135deg,#f0c979,#a16500)"><span class="date">10 JUN 2026</span></div>
        <div class="news-body">
          <h3>Career Day mempertemukan siswa dengan profesional</h3>
          <p>Siswa memperoleh wawasan kuliah, karier, portofolio, dan kompetensi masa depan.</p><a class="text-link" href="#">Baca berita <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle;margin-left:3px">
              <path d="M5 12h14" />
              <path d="m12 5 7 7-7 7" />
            </svg></a>
        </div>
      ...
      <article class="card news-card reveal">
        <div class="news-thumb" style="background:linear-gradient(135deg,#97d5b9,#14754e)"><span class="date">02 JUN 2026</span></div>
        <div class="news-body">
          <h3>Pameran karya kreatif dan produk kewirausahaan</h3>
          <p>Karya desain, aplikasi, produk bisnis, dan penelitian siswa dipamerkan kepada publik.</p><a class="text-link" href="#">Baca berita <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle;margin-left:3px">
              <path d="M5 12h14" />
              <path d="m12 5 7 7-7 7" />
            </svg></a>
        </div>
...
<section class="section" style="background:var(--card)">
  <div class="container"><span class="kicker">Galeri</span>
...
<section class="section">
  <div class="container split">
    <div class="reveal">
      ...
      <a class="btn btn-primary" href="{{ route('login') }}">Masuk Portal Orang Tua <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle;margin-left:4px">
          <path d="M5 12h14" />
          <path d="m12 5 7 7-7 7" />
        </svg></a>
    </div>
    <div class="card reveal" style="padding:30px">
      <div class="portal-kpis" style="grid-template-columns:1fr 1fr">
        <div class="portal-kpi">
          <div class="portal-kpi-label"><span>Rata-rata</span><span><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle">
                <line x1="12" y1="20" x2="12" y2="10" />
                <line x1="18" y1="20" x2="18" y2="4" />
                <line x1="6" y1="20" x2="6" y2="16" />
              </svg></span></div><strong class="portal-kpi-value">86,4</strong><span class="portal-kpi-note good">Di atas KKM</span>
        </div>
        <div class="portal-kpi">
          <div class="portal-kpi-label"><span>Kehadiran</span><span><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle">
                <rect width="18" height="18" x="3" y="4" rx="2" ry="2" />
                <line x1="16" y1="2" x2="16" y2="6" />
                <line x1="8" y1="2" x2="8" y2="6" />
                <line x1="3" y1="10" x2="21" y2="10" />
              </svg></span></div><strong class="portal-kpi-value">96,4%</strong><span class="portal-kpi-note good">Sangat baik</span>
        </div>
      </div>
      <div style="margin-top:22px">
        ...
        <div class="subject-progress-head" style="margin-top:16px"><strong>Bahasa Indonesia</strong><strong>90,2</strong></div>
        <div class="progress-track">
          <div class="progress-fill" style="--score:90.2%"></div>
        </div>
        <div class="subject-progress-head" style="margin-top:16px"><strong>Matematika</strong><strong>84,0</strong></div>
        <div class="progress-track">
          <div class="progress-fill" style="--score:84%"></div>
        </div>
      </div>
      <div class="portal-note" style="margin-top:24px"><strong>Catatan wali kelas</strong>
